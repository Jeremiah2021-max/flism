    ...
    Alert.alert(
      ...
      [
        { text: 'Cancel', style: 'cancel' },
        {
          text: 'Reject',
          style: 'destructive',
          onPress: () => rejectMutation.mutate({ id: asset.id, reason: 'Asset could not be verified. Please resubmit with clearer photos.' })
        },
      ]
    );
  }
        ...
        renderItem={({ item: asset }) => {
          ...
          return (
            <View style={[styles.assetCard, { backgroundColor: colors.surface, borderColor: colors.border }]}>
              ...
              {asset.serial_number && (
                <Text style={[styles.serialText, { color: colors.muted }]}>
