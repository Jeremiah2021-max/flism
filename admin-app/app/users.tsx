        ...
        renderItem={({ item }) => {
          ...
          return (
            <TouchableOpacity
              ...
              style={[styles.filterChip, { backgroundColor: filter === item.key ? '#003EC7' : colors.surface, borderColor: filter === item.key ? '#003EC7' : colors.border }]}
            >
              ...
              <View style={styles.cardTop}>
                ...
                <View style={{ alignItems: 'flex-end', gap: 4 }}>
                  <View style={[styles.kycBadge, { backgroundColor: user.is_kyc_complete ? '#E8F5E9' : '#FFF3E0' }]}>
                    <Ionicons name={user.is_kyc_complete ? 'checkmark-circle' : 'time-outline'} size={10} color={user.is_kyc_complete ? '#3B7D4A' : '#B86A00'} />
